      ...
      <div className="relative w-full pb-[100%] bg-gray-50 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
          <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 flex gap-2">
            <Link href="/detail" className="flex items-center gap-1 py-2 px-3 bg-white text-gray-800 text-sm font-medium rounded-lg hover:bg-gray-100 transition-colors duration-200 shadow-md">
              <Eye size={16} />
